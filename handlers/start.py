...
async def start_(client: Client, message: Message):
    await message.reply_text(
        f"""<b>⌯  ** مرحبا بك عزيزي {message.from_user.first_name}** \n
            ...
            [ 
                [
                    InlineKeyboardButton(
                        "⌯  اضف البوت الى مجموعـتك .", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                ],[
                    InlineKeyboardButton(
                        "⌯  ڪِـروب الدعم .", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "⌯  قـناة السورس  .", url=f"https://t.me/{UPDATES_CHANNEL}")               
                 ],[
                    InlineKeyboardButton(
                        "⌯  SoUrSe : MuSiC ", url="https://t.me/nnnnBn"
                    )
                ]
            ]
        ),
...
- رفض إرسال رسالة إلى المساعد في الخاص.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "SoUrSe : MuSiC", url=f"https://t.me/nnnnBn"
                    )
                ]
            ]
        )
